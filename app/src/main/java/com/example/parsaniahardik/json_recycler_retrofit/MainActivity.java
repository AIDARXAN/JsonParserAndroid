        ...
        try {
            ...
            if(obj.optString("status").equals("true")){
                ...
                for (int i = 0; i < dataArray.length(); i++) {
                    ...
                    modelRecycler.setImgURL(dataobj.getString("pk"));
                    modelRecycler.setName(dataobj.getString("title_en"));
                    modelRecycler.setCountry(dataobj.getString("title_kg"));
                    modelRecycler.setCity(dataobj.getString("title_ru"));
